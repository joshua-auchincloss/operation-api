...
pub fn derive_error(tokens: TokenStream) -> TokenStream {
        ...
        match var.fields.style {
            Style::Tuple => {
                ...
                gen_variant.extend(quote! {
                    ...
                    m.insert(#var_ident_str.into(), operation_api_sdk::OneOfVariant {
    ...
    let def_tokens = quote! {
        static #def_static_ident: std::sync::LazyLock<operation_api_sdk::Definitions> = std::sync::LazyLock::new(|| {
            use operation_api_sdk::{OfNamespace, Defined, Typed};

            let mut m = std::collections::BTreeMap::<_, operation_api_sdk::OneOfVariant>::new();
            #gen_variant

            const VERSION: operation_api_sdk::Version = operation_api_sdk::Version::new(#version_lit);
            operation_api_sdk::Definitions::ErrorV1(operation_api_sdk::Error {
        ...
        impl operation_api_sdk::Defined for #enum_ident {
