...
operation_api_sdk::namespace! { "abc.corp.test" { BasicStruct , BasicStructWithReadme , KnownError , OperationErrorUnknown , SomeStructWithEnum , BasicIntEnum , BasicStrEnum , ErrorCode , SomeEnum , OperationError , } }
